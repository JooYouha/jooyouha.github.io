...
categories:
  - Cupcakes
  - Cakes
featured_image: /images/cory3.jpg
recipe:
...
---
These chocolate chocolate cupcakes have a stunning appearance and a rich, chocolatey sweetness. 
이 화면은 글씨체 폰트를 보기 위한 화면으로 현재 글씨체가 맘에 든다면 투표를 해주세요. 삥삥-- 삥---삥-----. '코리뽀리먼지'는 귀엽다. 이것은 팩트!
